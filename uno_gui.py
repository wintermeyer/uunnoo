...
class CardWidget(tk.Frame):
    def __init__(self, parent, card, clickable=False, click_callback=None):
        ...
        self.configure(bg=bg_color, width=80, height=120)
...
class UnoGUI:
    ...
    def setup_ui(self):
        ...
        self.discard_frame = tk.Frame(middle_frame, bg="#006400")
        self.discard_frame.pack(side=tk.LEFT, padx=50)
        
        tk.Label(self.discard_frame, text="Ablagestapel",
                font=("Arial", 14), bg="#006400", fg="white").pack()
        
        self.discard_pile_widget = tk.Frame(self.discard_frame, bg="#006400")
        self.discard_pile_widget.pack(pady=10)
        
        self.color_indicator = tk.Label(self.discard_frame, text="",
